...
; Constraints: [primitivetask17 primitivetask21 primitivetask22 primitivetask35 primitivetask54 primitivetask68 primitivetask77 dag glm mlpca dtcs rimp scale]
(define
(domain datascience_13_08)
...
:effect
    (and
        (primitivetask68)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask77
:parameters
    ()
:precondition
    ()
