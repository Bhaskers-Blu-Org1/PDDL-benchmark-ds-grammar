...
; Constraints: [primitivetask16 primitivetask17 primitivetask24 primitivetask34 primitivetask42 primitivetask43 primitivetask54 primitivetask56 primitivetask58 primitivetask72 glm]
(define
(domain datascience_11_01)
...
:effect
    (and
        ...
        (htn_task_mm ?htn_id1)
        (increase (total-cost) 1)))
(:action __forgo_primitivetask16
:parameters
    ()
:precondition
    ()
...
(:action __forgo_primitivetask17
:parameters
    ()
:precondition
    ()
...
:effect
    (and
        (primitivetask24)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask34
:parameters
    ()
:precondition
    ()
