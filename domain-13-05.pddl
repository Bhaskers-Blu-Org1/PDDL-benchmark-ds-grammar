...
; Constraints: [primitivetask10 primitivetask25 primitivetask42 primitivetask44 primitivetask48 primitivetask54 primitivetask56 primitivetask57 primitivetask65 primitivetask71 est rfc kncw]
(define
(domain datascience_13_05)
...
:effect
    (and
        ...
        (htn_task_mm ?htn_id1)
        (increase (total-cost) 1)))
(:action __forgo_primitivetask10
:parameters
    ()
:precondition
    ()
...
:effect
    (and
        (primitivetask25)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask42
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask42)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask44
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask44)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask48
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask48)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask54
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask54)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask56
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask56)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask57
:parameters
    ()
:precondition
    ()
...
:effect
    (and
        (primitivetask65)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask71
:parameters
    ()
:precondition
    ()
