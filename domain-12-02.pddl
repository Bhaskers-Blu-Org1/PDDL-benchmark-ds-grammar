...
; Constraints: [primitivetask43 primitivetask51 primitivetask58 primitivetask60 primitivetask66 primitivetask67 primitivetask69 primitivetask75 mlpcs dtcs gbcl nys]
(define
(domain datascience_12_02)
...
(:action __forgo_primitivetask51
:parameters
    ()
:precondition
    ()
...
:effect
    (and
        (primitivetask58)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask60
:parameters
    ()
:precondition
    ()
