...
; Constraints: [primitivetask1 primitivetask11 primitivetask12 primitivetask36 primitivetask47 primitivetask49 primitivetask53 primitivetask67 primitivetask68 start rimps wtfm pcas]
(define
(domain datascience_13_02)
...
(:action __forgo_primitivetask11
:parameters
    ()
:precondition
    ()
...
:effect
    (and
        (primitivetask12)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask36
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask36)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask47
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask47)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask49
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask49)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask53
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask53)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask67
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask67)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask68
:parameters
    ()
:precondition
    ()
