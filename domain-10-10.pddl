...
; Constraints: [primitivetask13 primitivetask21 primitivetask22 primitivetask29 primitivetask35 primitivetask36 primitivetask63 dtcc kncw wtfm]
(define
(domain datascience_10_10)
...
:effect
    (and
        (primitivetask36)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask63
:parameters
    ()
:precondition
    ()
