...
; Constraints: [primitivetask35 primitivetask42 primitivetask50 primitivetask53 primitivetask58 primitivetask68 primitivetask73 primitivetask75 glm mlpcl rfc knc rimp]
(define
(domain datascience_13_01)
...
:effect
    (and
        (primitivetask68)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask73
:parameters
    ()
:precondition
    ()
