...
; Constraints: [primitivetask22 primitivetask28 primitivetask32 primitivetask36 primitivetask57 primitivetask61 primitivetask67 primitivetask68 primitivetask71 primitivetask78 glm rimp]
(define
(domain datascience_12_07)
...
:effect
    (and
        ...
        (htn_task_mm ?htn_id1)
        (increase (total-cost) 1)))
(:action __forgo_primitivetask22
:parameters
    ()
:precondition
    ()
...
(:action __forgo_primitivetask28
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask28)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask32
:parameters
    ()
:precondition
    ()
...
:effect
    (and
        (primitivetask57)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask61
:parameters
    ()
:precondition
    ()
...
:effect
    (and
        (primitivetask71)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask78
:parameters
    ()
:precondition
    ()
