...
; Constraints: [primitivetask1 primitivetask13 primitivetask14 primitivetask42 primitivetask45 primitivetask48 primitivetask53 primitivetask57 start glm mlpca dtcc gnb]
(define
(domain datascience_13_09)
...
:effect
    (and
        (primitivetask13)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask14
:parameters
    ()
:precondition
    ()
...
:effect
    (and
        (primitivetask42)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask45
:parameters
    ()
:precondition
    ()
