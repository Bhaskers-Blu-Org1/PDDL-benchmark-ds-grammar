...
; Constraints: [primitivetask13 primitivetask19 primitivetask26 primitivetask31 primitivetask44 primitivetask50 primitivetask66 primitivetask70 primitivetask72 mlpcl dtc]
(define
(domain datascience_11_06)
...
(:action __forgo_primitivetask19
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask19)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask26
:parameters
    ()
:precondition
    ()
