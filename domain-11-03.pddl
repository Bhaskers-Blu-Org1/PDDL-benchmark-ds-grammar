...
; Constraints: [primitivetask27 primitivetask51 primitivetask53 primitivetask61 primitivetask76 primitivetask78 dag glmpen mlpca ebm nysk]
(define
(domain datascience_11_03)
...
:effect
    (and
        ...
        (htn_task_mm ?htn_id1)
        (increase (total-cost) 1)))
(:action __forgo_primitivetask27
:parameters
    ()
:precondition
    ()
