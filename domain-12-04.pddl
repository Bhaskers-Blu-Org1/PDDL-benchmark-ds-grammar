...
; Constraints: [primitivetask6 primitivetask11 primitivetask15 primitivetask18 primitivetask37 primitivetask48 primitivetask50 primitivetask68 primitivetask78 mlpcs dtcc gnb]
(define
(domain datascience_12_04)
...
:effect
    (and
        (primitivetask11)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask15
:parameters
    ()
:precondition
    ()
...
:effect
    (and
        (primitivetask48)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask50
:parameters
    ()
:precondition
    ()
