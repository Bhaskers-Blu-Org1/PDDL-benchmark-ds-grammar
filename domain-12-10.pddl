...
; Constraints: [primitivetask7 primitivetask49 primitivetask50 primitivetask52 primitivetask59 primitivetask66 primitivetask70 primitivetask76 glm mlpca rimps nysk]
(define
(domain datascience_12_10)
...
:effect
    (and
        (primitivetask50)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask52
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask52)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask59
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask59)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask66
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask66)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask70
:parameters
    ()
:precondition
    ()
:effect
    (and
        (primitivetask70)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask76
:parameters
    ()
:precondition
    ()
