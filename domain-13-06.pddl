...
; Constraints: [primitivetask12 primitivetask13 primitivetask31 primitivetask35 primitivetask37 primitivetask55 primitivetask75 primitivetask78 glmslv gbcl kncm urfnc pcas]
(define
(domain datascience_13_06)
...
(:action __forgo_primitivetask13
:parameters
    ()
:precondition
    ()
...
:effect
    (and
        (primitivetask31)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask35
:parameters
    ()
:precondition
    ()
...
:effect
    (and
        (primitivetask55)
        (increase (total-cost) 505)))
(:action __forgo_primitivetask75
:parameters
    ()
:precondition
    ()
